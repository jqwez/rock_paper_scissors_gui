...
def start_game():
    computer_talk.set("Rock, Paper, Scicsors, SHOOT! :")

def quit_game():
    computer_talk = (f"Thanks for playing!!!! \n"
                  "\n"
...
def ask_score():
    computer_talk = (f"I have won {score[0]}, you have won {score[1]}, and we have tied {score[2]}!")

computer_talk = "THIS IS SAMPLE OF COMPUTER TALKING"
